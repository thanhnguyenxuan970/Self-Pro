---
name: recheck
description: Recheck and refine the current plan until no errors, conflicts, or omissions remain and confidence reaches at least 95%. Use for plan hardening.
---

Thực hiện vòng lặp recheck sau đây cho plan hiện tại (đọc plan artifact hiện hành hoặc plan file do người dùng chỉ định):
