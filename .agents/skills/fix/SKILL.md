---
name: fix
description: Fix identified bugs, errors, and code issues in priority order, then verify the affected behavior. Use after findings or failures are known.
---

Hãy sửa tất cả các issue trong codebase hiện tại theo thứ tự ưu tiên:
