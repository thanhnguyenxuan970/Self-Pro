---
name: review
description: Review the current system, code, and delivery pipeline for bugs, omissions, conflicts, security risks, and missing tests. Use for comprehensive reviews.
---

Hãy thực hiện một review toàn diện của hệ thống hiện tại. Kiểm tra theo thứ tự sau:
