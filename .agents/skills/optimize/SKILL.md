---
name: optimize
description: Optimize code by removing meaningful redundancy, improving performance, and simplifying maintainability without changing behavior. Use for optimization requests.
---

Hãy tối ưu codebase hiện tại theo các tiêu chí sau:
