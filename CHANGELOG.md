...
### Fixed
- **Android adaptive release compatibility**: removed app-owned portrait and legacy system-bar restrictions, enabled predictive back dispatch, and migrated `MainActivity` away from deprecated back handling; release metadata is 2.0.3.l (versionCode 80). A signed AAB and API 34 release stress loops passed; API 35/36, tablet/foldable, Play re-scan, and R8 obfuscation remain pending.
