...
const vi = {
  ...
  scoringPointRules: [{ title: '+1 điểm mỗi 30 phút', example: 'Theo thời gian · Chạy bộ, đọc sách' }, { title: '+5 điểm mỗi lần hoàn thành', example: 'Không thời gian · Bài tập, dọn dẹp' }],
  ...
  streakMilestoneHeadline: (n: number) => `Bạn đã giữ streak ${n} ngày!`,
  streakMilestoneReward: (stars: number) => `+${stars} sao flex`,
  streakMilestoneBoost: (m: number) => `⚡ ${m}× sao hôm nay`,
  streakMilestoneSubline: 'Phần thưởng này không ảnh hưởng rank hay kho sao.',
  ...
  analyticsWeeklyRank: 'HẠNG TUẦN NÀY',
  analyticsMetrics: 'CHỈ SỐ',
  heatmapActiveDays: 'ngày\nđã tô',
  heatmapLess: 'Ít',
  heatmapMore: 'Nhiều',
  heatmapLegendTitle: 'Sao mỗi ngày',
  heatmapLegendSubtitle: 'Số sao kiếm được trong ngày,\ntheo màu ô',
  ...
  challengeRuleDaily: 'Làm mỗi ngày',
  challengeRuleReset: 'Lỡ 1 ngày → reset',
  ...
  challengeWeeklyRulesBody: (weeklyTarget: number) =>
    `Đủ ${weeklyTarget} buổi mỗi tuần — ngày nào cũng được. Ngày nghỉ không tính là lỡ. Mỗi tuần reset Thứ 2.`,
  ...
  challengeFailedEncouragement: '💚 Lần tới, cùng đi đủ mục tiêu nhé.',
  ...
  achFirstLogDesc: 'Ghi nhận một hoạt động đầu tiên.',
  ...
  achPerfectLoopDesc: 'Vượt chỉ tiêu tuần của một thử thách.',
  achEarlyBird: 'Chim sớm',
  achEarlyBirdDesc: 'Ghi nhận hoạt động trước 9 giờ sáng.',
  achNightOwl: 'Cú đêm',
  achNightOwlDesc: 'Ghi nhận hoạt động từ 10 giờ đêm.',
  achStreakSaver: 'Giữ chuỗi',
  achStreakSaverDesc: 'Duy trì chuỗi ngày liên tiếp 14 ngày.',
  ...
  tutStep2Body: 'Hoạt động theo giờ nhận thêm điểm theo thời lượng.',
...
const en: typeof vi = {
  ...
  analyticsWeeklyRank: 'THIS WEEK\'S RANK',
