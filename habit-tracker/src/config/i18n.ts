...
const vi = {
  ...
  scoringGuideTitle: 'Cách tính điểm & sao',
  scoringGuideRules: ['Hoạt động từ 30 phút trở xuống: +1 điểm', 'Đạt từ 50 điểm trong ngày: thưởng +1 sao'],
...
const en: typeof vi = {
  ...
  scoringGuideRules: ['Activities up to 30 minutes: +1 point', 'Reach 50 points in a day: +1 bonus star'],
