...
const vi = {
  ...
  scoringPointRules: [{ title: '+1 điểm mỗi 30 phút', example: 'Hoạt động theo thời gian · Chạy bộ, Đọc sách' }, { title: '+5 điểm mỗi lần hoàn thành', example: 'Hoạt động không theo thời gian · Bài tập, Dọn dẹp' }],
...
const en: typeof vi = {
  ...
  scoringPointRules: [{ title: '+1 point per 30 minutes', example: 'Time activity · Running, Reading' }, { title: '+5 points per completion', example: 'No-duration activity · Homework, Cleaning' }],
