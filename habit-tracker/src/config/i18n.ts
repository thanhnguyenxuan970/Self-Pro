...
const vi = {
  ...
  scoringPointRules: [{ title: '+1 điểm mỗi 30 phút', example: 'Hoạt động theo thời gian · Chạy bộ, Đọc sách' }, { title: 'Điểm cố định khi hoàn thành', example: 'Bài tập, Dọn dẹp' }],
...
const en: typeof vi = {
  ...
  scoringPointRules: [{ title: '+1 point per 30 minutes', example: 'Time activity · Running, Reading' }, { title: 'Fixed points per completion', example: 'Homework, Cleaning' }],
