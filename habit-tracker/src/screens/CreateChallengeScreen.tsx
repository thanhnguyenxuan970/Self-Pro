      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.habitRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.75} accessibilityRole="radio" accessibilityState={{ checked: taskTypeId === null }}
          ...
          {tasks.map(task => {
            ...
            return <TouchableOpacity key={task.id} style={[styles.habitChip, on && styles.habitChipOn]}
              ...
              activeOpacity={0.75} accessibilityRole="radio" accessibilityState={{ checked: on }}
...
function makeStyles(C: AppColors) {
  return StyleSheet.create({
    ...
    habitRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm }, habitChip: { maxWidth: 190, minHeight: 48, justifyContent: 'center', paddingHorizontal: Spacing.md, paddingVertical: 10, borderRadius: Radii.pill, backgroundColor: C.surface, borderWidth: 1, borderColor: C.line }, habitChipOn: { backgroundColor: C.primarySoft, borderColor: C.primaryPress }, habitChipText: { ...Typography.bodyStrong, color: C.ink2 }, habitChipTextOn: { color: C.primaryText },
    thresholds: { gap: Spacing.xs }, modeRow: { flexDirection: 'row', gap: Spacing.sm }, modeCard: { flex: 1, minHeight: 148, padding: Spacing.sm, borderRadius: Radii.lg, borderWidth: 1, borderColor: C.line2, backgroundColor: C.surface, alignItems: 'center', justifyContent: 'center', gap: 4 }, modeCardOn: { backgroundColor: C.primarySoft, borderColor: C.primaryPress }, modeBadge: { position: 'absolute', top: 10, right: 10, width: 20, height: 20, borderRadius: 10, backgroundColor: C.primary, alignItems: 'center', justifyContent: 'center' }, modeBadgeText: { color: C.onAccent, fontFamily: FontFamily.bold, fontSize: 12 }, modeIcon: { fontSize: 25 }, modeTitle: { ...Typography.bodyStrong, color: C.inkDark, textAlign: 'center' }, modeTitleOn: { color: C.primaryText }, modeSub: { ...Typography.caption, color: C.ink2, textAlign: 'center' },
    chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm }, chip: { minHeight: 48, paddingHorizontal: Spacing.md, justifyContent: 'center', borderRadius: Radii.pill, borderWidth: 1, borderColor: C.line2, backgroundColor: C.surface }, chipOn: { backgroundColor: C.primarySoft, borderColor: C.primaryPress }, chipText: { ...Typography.bodyStrong, color: C.ink2 }, chipTextOn: { color: C.primaryText }, customChip: { minHeight: 48, paddingHorizontal: Spacing.md, justifyContent: 'center', borderRadius: Radii.pill, borderWidth: 1, borderStyle: 'dashed', borderColor: C.line2 }, customChipText: { ...Typography.bodyStrong, color: C.muted },
    ...
    rulesWrap: { marginTop: Spacing.lg }, rulesHeader: { flexDirection: 'row', alignItems: 'center', gap: Spacing.xs, marginBottom: Spacing.xs }, rulesTitle: { ...Typography.bodyStrong, color: C.inkDark }, ruleTag: { ...Typography.caption, color: C.primaryText, fontFamily: FontFamily.bold, borderWidth: 1, borderColor: C.primaryPress, borderRadius: Radii.pill, paddingHorizontal: Spacing.xs }, rulesCard: { flexDirection: 'row', gap: Spacing.sm, backgroundColor: C.surface2, borderRadius: Radii.lg, padding: Spacing.md }, rulesIcon: { fontSize: 20 }, rulesBody: { ...Typography.secondary, color: C.ink2, flex: 1, lineHeight: 19 },
