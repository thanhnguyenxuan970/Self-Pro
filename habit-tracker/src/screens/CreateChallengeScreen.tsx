...
function makeStyles(C: AppColors) {
  return StyleSheet.create({
    ...
    chipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm }, chip: { minHeight: 48, paddingHorizontal: Spacing.md, justifyContent: 'center', borderRadius: Radii.pill, borderWidth: 1, borderColor: C.line2, backgroundColor: C.surface }, chipOn: { backgroundColor: C.primarySoft, borderColor: C.primary }, chipText: { ...Typography.bodyStrong, color: C.ink2 }, chipTextOn: { color: C.primaryText }, customChip: { minHeight: 48, paddingHorizontal: Spacing.md, justifyContent: 'center', borderRadius: Radii.pill, borderWidth: 1, borderStyle: 'dashed', borderColor: C.line2 }, customChipText: { ...Typography.bodyStrong, color: C.muted },
