...
function makeStyles(C: AppColors) {
  return StyleSheet.create({
    ...
    tileDesc: { fontSize: 12, color: C.ink2, marginTop: 1, textAlign: 'center' },
    price: {
