      ...
      <ScrollView ref={scrollRef} horizontal showsHorizontalScrollIndicator={false} onContentSizeChange={() => scrollRef.current?.scrollToEnd({ animated: false })}>
        <View>
          <View style={styles.months}>{weeks.map((week, i) => {
            ...
            return month ? <Text key={i} style={[styles.month, { left: i * HEATMAP_COLUMN_PITCH }]}>{month}</Text> : null;
          })}</View>
          <AnimatedWeeks
...
function makeStyles(C: AppColors) {
  return StyleSheet.create({
    card: { marginHorizontal: Spacing.lg, marginTop: 22, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 16, backgroundColor: C.surface, borderWidth: 1, borderColor: C.line, borderRadius: Radii.xxl, overflow: 'hidden', ...Shadows.light }, boostGlow: { position: 'absolute', width: 230, height: 230, top: -8, right: -8 },
    ...
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }, headerTitle: { flex: 1 }, headerActions: { alignItems: 'flex-end' }, yearWrap: { alignItems: 'flex-end', gap: 2 }, yearText: { color: C.primaryText, fontSize: 16, fontFamily: FontFamily.extraBold }, legendButton: { width: 24, height: 24, borderRadius: 12, borderWidth: 1, borderColor: C.muted, backgroundColor: C.surface2, alignItems: 'center', justifyContent: 'center' }, legendButtonText: { color: C.inkDark, fontSize: 13, lineHeight: 16, fontFamily: FontFamily.extraBold },
    totalRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 2 }, total: { color: C.inkDark, fontSize: 48, lineHeight: 56, letterSpacing: -2.5, fontFamily: FontFamily.extraBold }, totalLabel: { maxWidth: 128, color: C.muted, fontSize: 16, lineHeight: 20, fontFamily: FontFamily.bold },
    rewardRow: { flexDirection: 'column', alignItems: 'flex-start', gap: 10, marginBottom: 14 }, rewardPill: { maxWidth: '100%', flexShrink: 1, backgroundColor: C.surface2, borderRadius: Radii.pill, paddingHorizontal: 14, paddingVertical: 8 }, rewardText: { flexShrink: 1, color: C.inkDark, fontSize: 15, fontFamily: FontFamily.bold }, boostBadge: { position: 'relative', overflow: 'hidden', borderRadius: Radii.pill, paddingHorizontal: 10, paddingVertical: 5 }, boostBadgeText: { fontSize: 12, fontFamily: FontFamily.extraBold, letterSpacing: 0.3 }, badgeSweep: { position: 'absolute', top: 0, bottom: 0, width: 24, transform: [{ skewX: '-18deg' }] },
    gridRow: { flexDirection: 'row' }, rail: { width: 24, marginTop: 24, gap: HEATMAP_CELL_GAP }, dayLabel: { height: 17, color: C.faint, fontSize: 11, lineHeight: 17, fontFamily: FontFamily.semiBold }, months: { height: 20, position: 'relative' }, month: { position: 'absolute', width: 36, color: C.faint, fontSize: 11, lineHeight: 14, fontFamily: FontFamily.semiBold }, weeks: { flexDirection: 'row', gap: HEATMAP_CELL_GAP }, week: { gap: HEATMAP_CELL_GAP }, cell: { width: HEATMAP_CELL_SIZE, height: HEATMAP_CELL_SIZE, borderRadius: 4, overflow: 'hidden' }, emptyCell: {}, todayCell: { borderWidth: 1.6, borderStyle: 'solid', borderColor: C.primary },
    legend: { marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', gap: 6 }, legendLabel: { color: C.faint, fontSize: 13, fontFamily: FontFamily.medium }, legendCell: { width: HEATMAP_CELL_SIZE, height: HEATMAP_CELL_SIZE, borderRadius: 4 },
