...
function makeStyles(C: ReturnType<typeof useTheme>['colors'], top: number, bottom: number, rare: boolean) { return StyleSheet.create({ sheetBackdrop: { flex: 1, paddingTop: top + 10, paddingHorizontal: 14 }, sheet: { minHeight: 92, borderRadius: Radii.xl, backgroundColor: C.surface, borderWidth: 1, borderColor: C.line, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 12, alignSelf: 'center', width: '100%', maxWidth: 480 }, sheetCopy: { flex: 1 }, backdrop: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(8,10,9,.9)', paddingHorizontal: 28 }, glow: { position: 'absolute', width: 390, height: 390, borderRadius: 195, backgroundColor: rare ? C.primary : 'transparent' }, hero: { alignItems: 'center', width: '100%' }, eyebrow: { color: C.primaryText, fontFamily: FontFamily.extraBold, fontSize: 12, letterSpacing: 1.4, marginBottom: 12 }, title: { color: '#FFF', fontFamily: FontFamily.extraBold, fontSize: 28, lineHeight: 35, textAlign: 'center', marginTop: 22 }, sheetTitle: { color: C.inkDark, fontFamily: FontFamily.extraBold, fontSize: 16 }, description: { color: rare ? 'rgba(255,255,255,.72)' : C.muted, fontFamily: FontFamily.semiBold, fontSize: 13, lineHeight: 18, textAlign: 'center', marginTop: 7 }, tierChip: { color: C.primaryText, fontFamily: FontFamily.extraBold, fontSize: 12, letterSpacing: .8, marginTop: 12 }, confetti: { position: 'absolute', width: 8, height: 12, borderRadius: 2 }, cta: { position: 'absolute', bottom: Math.max(24, bottom + 12), left: 26, right: 26, minHeight: 54, borderRadius: Radii.md, alignItems: 'center', justifyContent: 'center' }, ctaText: { fontFamily: FontFamily.extraBold, fontSize: 16 } }); }
