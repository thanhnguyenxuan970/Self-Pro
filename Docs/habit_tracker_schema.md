...
CREATE TABLE users (
  ...
  lifetime_stars  REAL NOT NULL DEFAULT 0,      -- migration v23: lifetime rank state, never resets
...
-- 6. WEEKLY SUMMARY (weekly stats/challenge-pacing only as of migration v23 —
